...
const importSeed = (
  ...
  return {
    ...
    totalCommissionRate: extra.totalCommissionRate ?? 25,
    sellerCommissionRate: extra.sellerCommissionRate ?? extra.commissionRate ?? 17,
    commissionRate: extra.commissionRate ?? extra.sellerCommissionRate ?? 17,
...
export const initialSalesDataImports: SalesDataImport[] = [
  ...
  importSeed('sales-005', 'SCH-005', 'fit-table-manual', 'manual', '확정 완료', '정산 생성됨', 112, 3_136_000, { confirmedAt: '2026-07-14 17:20', confirmedBy: '허수정', totalCommissionRate: 25, sellerCommissionRate: 17, sampleDeductionAmount: 0 }),
