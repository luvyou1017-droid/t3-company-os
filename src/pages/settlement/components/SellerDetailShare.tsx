...
export function SellerDetailShare({settlementId,enabled,createImage,message}:{settlementId:string;enabled:boolean;createImage:()=>Promise<Blob>;message:()=>string}) {
